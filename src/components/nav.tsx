...
export function Nav({ orgId, patient }: NavProps) {
  ...
  return (
    <nav className="flex items-center justify-between px-7 py-3.5 border-b border-slate-800 bg-slate-900">
      <div className="flex items-center gap-3">
        {/* Logo */}
        <div className="w-7 h-7 rounded-md bg-blue-500 flex items-center justify-center text-sm">
          ⚕
        </div>
        <span className="font-bold text-base tracking-tight text-white">
          health <span className="text-blue-400">demo</span>
        </span>
        {/* Org slug — shows which tenant is active */}
